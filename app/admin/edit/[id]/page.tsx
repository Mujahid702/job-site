      ...
      {activeTab === "Edit" ? (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-8">
            <div className="bg-slate-900 p-8 rounded-[2.5rem] text-white shadow-xl shadow-slate-200 sticky top-12">
               ...
               <div className="mt-10 pt-10 border-t border-white/5 space-y-4">
                  <p className="text-xs font-bold text-slate-500 uppercase tracking-widest text-center">Danger Zone</p>
                  <button className="w-full py-4 bg-red-500/10 text-red-500 font-bold rounded-2xl hover:bg-red-500 hover:text-white transition-all flex items-center justify-center gap-2">
